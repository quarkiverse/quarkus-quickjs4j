...
public class ScriptInterfaceProcessor extends AbstractProcessor {
    ...
    /**
     * Generates TypeScript definition file for context class methods.
     * This allows TypeScript implementations to have proper type information
     * for the builtin functions exposed from Java.
     */
    private void generateTypeScriptDefinitionsFor(TypeElement scriptInterfaceElement, TypeElement contextClass) {
        log(NOTE, "Generating TypeScript definitions for context class: " + contextClass, null);
        ...
        tsContent.append("// TypeScript type definitions for Java context methods\n\n");
