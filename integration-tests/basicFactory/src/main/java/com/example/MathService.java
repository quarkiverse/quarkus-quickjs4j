...
public class MathService {
    ...
    @Inject
    ScriptInterfaceFactory<Calculator, Void> calculatorFactory;

    public int performCalculation() {
        String library = ScriptInterfaceUtils.loadScriptLibrary("dynamicCalculator.js");
        Calculator calculator = calculatorFactory.create(library, null);
